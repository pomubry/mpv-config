function setClipboard(text) {
  var env = mp.utils.get_env_list();
  var appData = env[1];
  var appDataPath = appData.slice(appData.indexOf("=") + 1);
  mp.commandv("run", appDataPath + "/mpv/scripts/copyTime.bat", text);
}
